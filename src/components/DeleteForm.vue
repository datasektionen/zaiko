  ...
  <div>
    <div>
      <div class="flex gap-4 justify-center mt-4">
        <button @click="Comfirm" class="bg-(--zaiko-bad-color) p-2 gap-2 flex items-center text-(--zaiko-text-hc) rounded-md cursor-pointer">
...
function Comfirm() {
  props.deleteFunc(props.item as unknown as S).then(() => {
